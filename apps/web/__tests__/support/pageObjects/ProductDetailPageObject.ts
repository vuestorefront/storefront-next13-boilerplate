export class ProductDetailPageObject {
    ...
    get addToCartButton() {
        return cy.getByTestId('button').find('Add to cart');
      }
  ...
  assertProductDetailPageElements(data) {
    this.productTitle
      ...
      // this.addToCartButton.should('be.visible'); need to figure out this one @PawełO
  }
}
